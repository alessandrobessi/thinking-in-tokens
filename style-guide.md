...
| Tourist showing a photo instead of describing a street in words | Multimodality (shared representation across formats) | Ch. 24 | Directly extends Ch. 5's cities-on-a-map analogy — a photo and a sentence about the same street are different formats that can land at the same point. |
